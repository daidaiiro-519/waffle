...
**読み手が中身を読む前に、その節が何を言っているかを掴めるようにする。**
対象外は、それ自体が一文である節だけである。

**この規則は、節の中の面や列の見出しにも及ぶ。**

```
悪い   変更前 ／ 変更後
良い   変更前 ── 1つの名前が5種類の主張を担う
       変更後 ── 主張が名前になる
```

見出しを読んだ時点で対比が済めば、図と表は確かめるために見るものになる。

**結論が末尾にあることは、先頭の一文の代わりにならない。**
連鎖の末尾に結論の段を持つ欄も、先頭の一文を省かない。
