...
def test_explicit_src_root_takes_precedence_over_architecture_ref():
    ...
    assert out["missing_implementation_file"], "srcRootが使われていれば usecase は見つからない"
...
def test_unknown_architecture_ref_returns_not_found():
    ...
    """
    out = asyncio.run(_call("check_usecase_class_drift", {"architectureRef": "no-such-architecture-document"}))
...
def test_check_scenario_drift_returns_four_fields():
    ...
    out = asyncio.run(_call("check_scenario_drift", {
        ...
        "testPath": "tests/application/integration/test_check_spec_integrity.py",
        "architectureRef": "architecture-waffle",
    }))
...
def test_check_verification_gate_returns_status_and_reasons(tmp_path):
    ...
    out = asyncio.run(_call("check_verification_gate", {
        ...
        "testPath": "tests/application/acceptance/test_check_verification_gate.py",
        "architectureRef": "architecture-waffle",
