...
|---|---|---|---|---|
| GO-TST-01 | 規格 | Go 標準ライブラリ `testing`<br>https://pkg.go.dev/testing | 2026-09-05 取得 | `func TestXxx` |
| GO-TST-02 | 規格 | `testing` パッケージ（並列）<br>https://pkg.go.dev/testing | 2026-09-05 取得 | `Parallel` |