...
ONEWAY = ('<svg viewBox="0 0 780 400" role="img" aria-label="入れ子や場合分けは詰まるが、並べて対応を宣言すると作りは1通りのまま3つの形が表せる">'
 ...
 + _t(558, 280, "置き場所は、どの対応でも変わらない", K, 9, "middle", True)
 + _t(558, 296, "領域は subdomains/ に1本　／　文脈は contexts/ に1つ", M, 8, "middle")
 + _t(558, 316, "schema は1つ　／　引き方は1つ　／　検査は1つ", K, 8.5, "middle", True)
