...
ONEWAY = ('<svg viewBox="0 0 780 400" role="img" aria-label="入れ子や場合分けは詰まるが、並べて対応を宣言すると作りは1通りのまま3つの形が表せる">'
 ...
 + _t(135, 124, "② 1領域が2文脈に割れると入らない", D, 8, "middle")
 # 2) 領域を上に入れ子
 ...
 + _t(383, 124, "③ 1文脈が2領域をまたぐと入らない", D, 8, "middle")
 # 3) 場合分け
 + _b(516, 34, 244, 96, "", D, 1.2)
 + _t(638, 52, "場合分けする", D, 9, "middle", True)
 + _b(528, 62, 70, 22, "①用", M, 1)
 + _b(604, 62, 70, 22, "②用", M, 1)
 + _b(680, 62, 70, 22, "③用", M, 1)
 ...
 + _t(558, 208, "3つの形は、宣言に現れる結果になる", M, 9, "middle", True)
 + _b(372, 222, 120, 40, "①", C, 1.1, 9, 16)
 + _t(432, 250, "領域1 → 文脈1", M, 8, "middle")
 + _b(500, 222, 120, 40, "②", C, 1.1, 9, 16)
 + _t(560, 250, "領域1 → 文脈2", M, 8, "middle")
 + _b(628, 222, 120, 40, "③", C, 1.1, 9, 16)
 + _t(688, 250, "領域2 → 文脈1", M, 8, "middle")
 ...
 '<b>並べて対応を宣言すれば、作りは1通りのまま、3つの形はすべて宣言の中に現れる</b> ── '
