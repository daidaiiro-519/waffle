...
TREE = ('<svg viewBox="0 0 780 400" role="img" aria-label="業務でフォルダを切ると入れ子になり、層でフォルダを切ると同じ業務が兄弟に散る">'
 ...
 + _f(44, 288, "integration.予約-請求.json", A) + _f(215, 288, "文脈どうしの連係", M)
 + _f(44, 306, "area.json", A) + _f(215, 306, "業務領域 ── 文脈と1対1とは限らない", M)
 ...
 '<b>業務領域は、この入れ子には入らない</b> ── 文脈との対応は1対1とは限らないので、'
 'フォルダの階層ではなく、対応を書いた1本として置く。')
