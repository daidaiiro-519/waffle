...
//
// このファイルが、bc-artifact-share の業務サービス「閲覧可否の判定」
// （ResolveViewability）の唯一の実装である。開けるかどうかを判じる瞬間は
// 閲覧者の要求時であり、その瞬間に居るのはこのランタイムだけなので、
// 業務のLambdaの側には実装を置かない。Python 側を探しても見つからないのは
// 欠落ではない。宣言との対応は、下記1〜2に対応するシナリオが
// tests/viewer-token-gate.test.mjs のラベルで結ばれることで保つ。
//
// 担うこと:
