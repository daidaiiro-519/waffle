...
| 種類 | 原典 | 版・取得日 | 照合する文字列 |
|---|---|---|---|
| 規格 | POSIX のシグナル（`SIGTERM`）<br>https://12factor.net/disposability | 2026-09-05 取得 | `SIGTERM` |
| 文献 | The Twelve-Factor App（廃棄容易性）<br>https://12factor.net/disposability | 2026-09-05 取得 | `disposability` |