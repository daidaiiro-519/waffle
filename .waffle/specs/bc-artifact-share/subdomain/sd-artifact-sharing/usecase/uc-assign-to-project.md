# 共有アーティファクトをまとめて見せる単位へ入れる・外す：uc-assign-to-project

## 概要

- 共有アーティファクトを、まとめて見せる単位へ加えたり外したりする操作。加えるとその単位の閲覧トークンでも開けるようになる。
...
sequenceDiagram
    actor 投稿者
    投稿者->>まとめて見せる単位: addArtifact（共有アーティファクトのArtifactId）
...
まとめて見せる単位Pが開ける状態にあり、共有アーティファクトAが公開されている。操作する者は招かれた投稿者である。
