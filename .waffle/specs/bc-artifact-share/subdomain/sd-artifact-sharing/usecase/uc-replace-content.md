# 共有URLと閲覧トークンと反応を保ったまま中身だけを入れ替える：uc-replace-content
...
- これが無いと、直すたびに新しく公開することになり、共有URLも閲覧トークンも渡し直しになる。それまでに集まった反応も切り離され、指摘と修正の往復が続かない。
...
共有アーティファクトAが公開されており、3件の反応が集まっている。操作する者は招かれた投稿者である。
