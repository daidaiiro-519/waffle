...
- 停止していた共有アーティファクトを再び開ける状態にする操作。共有URLも中身も反応もそのまま戻るが、閲覧トークンだけは必ず新しくなる。
...
- 再開したとき、共有URL・中身・反応を停止前と同じにすること
...
| コード | 条件 |
|---|---|
| `NOT_SUSPENDED` | - 対象の共有アーティファクトが停止していない |
