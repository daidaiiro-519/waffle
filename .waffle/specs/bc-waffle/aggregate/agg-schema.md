...
| 分類 | 観点 |
|---|---|
| 異常系 | 不変条件: Schemaファイル自体の物理的な整形は常に一意に定まる形と完全一致する |
...
### requiredなプロパティの除去は後方互換違反として検出される

| 分類 | 観点 |
|---|---|
| 異常系 | 境界: 公開済みの版に対する変更が、既存の instance を壊すかどうかの場合分け |
...
### requiredでないプロパティの除去は後方互換違反にならない

| 分類 | 観点 |
|---|---|
| 正常系 | 境界: 公開済みの版に対する変更が、既存の instance を壊すかどうかの場合分け |
...
### requiredなプロパティの改名は後方互換違反として検出される
...
### requiredでないプロパティの改名は後方互換違反にならない
