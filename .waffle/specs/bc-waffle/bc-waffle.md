...
| usecase | uc-scaffold-document / uc-query-document / uc-validate-document / uc-render-document / uc-scan-source-code / uc-lint-docstring / uc-check-spec-integrity / uc-check-scenario-drift / uc-check-schema-version-drift / uc-check-usecase-class-drift |
