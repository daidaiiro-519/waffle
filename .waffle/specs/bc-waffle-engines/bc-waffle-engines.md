...
| 種別 | メンバー |
|---|---|
| subdomain | sd-document-engine / sd-validation / sd-source-code / sd-docstring-linting / sd-reconciliation |
| aggregate | agg-document / agg-schema |
| usecase | uc-scaffold-document / uc-query-document / uc-validate-document / uc-render-document / uc-scan-source-code / uc-lint-docstring / uc-check-spec-integrity / uc-check-scenario-drift / uc-check-schema-version-drift |
