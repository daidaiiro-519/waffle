...
| 種別 | メンバー |
|---|---|
| subdomain | sd-document-engine / sd-validation / sd-reconciliation / sd-schema-governance |
| aggregate | agg-document / agg-schema |
| usecase | uc-scaffold-document / uc-query-document / uc-validate-document / uc-render-document / uc-scan-source-code / uc-lint-docstring / uc-migrate-schema-version |
